# Kitsune detection matrix — 120 rules vs 51 evaders
...
## Per-rule coverage — 88/120 rules catch ≥1 evader (rest in Gaps)
...
## Coverage gaps — 32/120 rules catch nothing yet
