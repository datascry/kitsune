...
| Detector | layer | baseline-firefox | camoufox-hardened | camoufox-headful | camoufox | full-stealth | human-mouse | nodriver | patchright | rebrowser | spoof-ua | stealth-naive | stealth-patched | vanilla | catches |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
| `br.webgl_software` | browser | · | · | · | · | · | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | · | 7 |
| `br.permissions_anomaly` | browser | · | · | · | · | ✓ | ✓ | · | ✓ | ✓ | ✓ | ✓ | ✓ | · | 7 |
| `br.no_chrome_object` | browser | · | · | · | · | · | ✓ | · | ✓ | ✓ | · | ✓ | ✓ | · | 5 |
| `br.tostring_tampered` | browser | · | · | · | · | · | · | · | · | · | · | · | · | · | 0 |
| `br.low_hardware_concurrency` | browser | · | · | · | · | · | · | · | · | · | · | · | · | · | 0 |
| `br.no_plugins` | browser | ✓ | · | · | · | · | ✓ | · | ✓ | ✓ | ✓ | ✓ | ✓ | · | 7 |
...
| **flagged** |  | **6/64** | **4/64** | **3/64** | **6/64** | **5/64** | **12/64** | **8/64** | **10/64** | **11/64** | **5/64** | **12/64** | **6/64** | **0/64** |  |
| **verdict** |  | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **human** |  |
