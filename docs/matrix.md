...
| Detector | layer | baseline-firefox | brave | camoufox-hardened | camoufox-headful | camoufox | full-stealth | human-mouse | max-stealth | nodriver | patchright | rebrowser | selenium-driverless | spoof-ua | stealth-naive | stealth-patched | undetected | vanilla | zendriver | catches |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
| `bh.input_entropy_floor` | behavioral | · | ✓ | · | · | · | · | · | · | ✓ | · | · | ✓ | · | · | · | ✓ | · | ✓ | 5 |
| `bh.no_input_before_action` | behavioral | · | ✓ | · | · | · | · | · | · | ✓ | · | · | ✓ | · | · | · | ✓ | · | ✓ | 5 |
...
| `br.chrome_runtime_missing` | browser | · | ✓ | · | · | · | · | · | · | ✓ | · | · | ✓ | · | · | · | ✓ | · | ✓ | 5 |
...
| **flagged** |  | **6/78** | **10/78** | **5/78** | **4/78** | **4/78** | **12/78** | **13/78** | **11/78** | **8/78** | **11/78** | **11/78** | **8/78** | **15/78** | **12/78** | **15/78** | **8/78** | **1/78** | **8/78** |  |
| **verdict** |  | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** | **bot** |  |
