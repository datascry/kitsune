...
|---|---|---|---:|---|
| `accept-lang-spoof` | bot | 1.00 | 15/190 | `br.cdp_runtime_enabled`, `net.accept_lang_vs_navigator`, `br.headless_ua` +5 |
| `apify-fp-inject` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `br.permissions_anomaly`, `br.no_chrome_object` +3 |
| `audio-noise` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +4 |
| `audio-readback-spoof` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +4 |
| `azuretls` | bot | 1.00 | 4/190 | `net.h2_header_order_vs_ua`, `net.tcp_os_vs_ua`, `net.no_js_execution` +1 |
| `baseline-firefox` | bot | 0.95 | 6/190 | `br.webdriver_present` |
| `brave-fake-proxy` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +4 |
| `brave-fake` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +4 |
| `brave` | bot | 0.99 | 6/190 | `br.webdriver_present`, `br.headless_ua` |
| `camoufox-hardened-behave` | suspicious | 0.49 | 5/190 | — |
| `camoufox-hardened` | suspicious | 0.49 | 6/190 | — |
| `camoufox-headful` | suspicious | 0.47 | 4/190 | — |
| `camoufox-linux-coherent` | suspicious | 0.49 | 6/190 | — |
| `camoufox-linux` | suspicious | 0.49 | 6/190 | — |
| `camoufox-macos` | bot | 0.95 | 7/190 | `net.tcp_os_vs_ua`, `br.font_mac_internal` |
| `camoufox-socks-webrtc` | suspicious | 0.49 | 5/190 | — |
| `camoufox-touch-incoherent` | bot | 0.85 | 6/190 | `br.pointer_touch_incoherent` |
| `camoufox` | bot | 1.00 | 3/190 | `net.tcp_os_vs_ua`, `net.no_js_execution`, `net.tls_grease_vs_ua` |
| `canvas-geometry-spoof` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +4 |
| `canvas-lie` | bot | 1.00 | 15/190 | `br.cdp_runtime_enabled`, `br.canvas_lie`, `br.headless_ua` +5 |
| `canvas-spoof` | bot | 1.00 | 16/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +6 |
| `cdc-leak` | bot | 1.00 | 14/190 | `br.webdriver_present`, `br.cdp_runtime_enabled`, `br.headless_ua` +4 |
...
| `curl-http2` | bot | 1.00 | 7/190 | `net.h2_unknown_vs_ua`, `net.h2_header_order_vs_ua`, `net.tcp_os_vs_ua` +4 |
| `curl-impersonate` | bot | 0.90 | 1/190 | `net.no_js_execution` |
| `datacenter-origin-proxied` | bot | 1.00 | 7/190 | `net.datacenter_origin_proxied` |
| `domrect-spoof` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +4 |
| `electron-leak` | bot | 1.00 | 15/190 | `br.automation_globals`, `br.electron_process`, `br.cdp_runtime_enabled` +5 |
| `firefox-coherent` | bot | 0.95 | 10/190 | `br.webdriver_present` |
| `firefox-os-spoof` | bot | 1.00 | 12/190 | `br.webdriver_present`, `net.tcp_os_vs_ua`, `br.navplatform_vs_ua` +2 |
| `floor-spoof` | bot | 1.00 | 8/190 | `br.tostring_tampered`, `br.nav_property_spoofed`, `br.webdriver_getter_tampered` +1 |
| `font-os-leak` | bot | 1.00 | 18/190 | `br.cdp_runtime_enabled`, `net.ch_ua_version_vs_ua`, `net.tcp_os_vs_ua` +7 |
| `fp-rotation` | bot | 0.85 | 7/190 | `br.fingerprint_unstable_within_session` |
| `full-stealth` | bot | 1.00 | 16/190 | `br.cdp_runtime_enabled`, `net.ch_ua_version_vs_ua`, `br.ch_he_headless` +7 |
| `go-tls-h2-rotate` | bot | 0.99 | 3/190 | `net.h2_unknown_vs_ua`, `net.h2_unstable_within_session`, `net.no_js_execution` |
| `go-tls-madeyoureset` | bot | 1.00 | 6/190 | `net.h2_unknown_vs_ua`, `net.h2_header_order_vs_ua`, `net.h2_madeyoureset` +3 |
| `go-tls-rotate` | bot | 1.00 | 5/190 | `net.h2_unknown_vs_ua`, `net.ja4_unstable_within_session`, `net.no_js_execution` +2 |
| `go-tls-static-ext` | bot | 1.00 | 4/190 | `net.h2_unknown_vs_ua`, `net.tls_ext_order_static_within_session`, `net.no_js_execution` +1 |
| `go-tls-web-bot-auth-replay` | bot | 0.98 | 2/190 | `net.web_bot_auth_nonce_replay`, `net.no_js_execution` |
| `go-tls-web-bot-auth` | bot | 0.98 | 2/190 | `net.web_bot_auth_invalid`, `net.no_js_execution` |
| `go-tls` | bot | 0.99 | 3/190 | `net.h2_unknown_vs_ua`, `net.no_js_execution`, `net.tls_pq_keyshare_vs_ua` |
| `h2-continuation-flood` | bot | 0.99 | 2/190 | `net.h2_continuation_flood`, `net.no_js_execution` |
| `h2-control-flood` | bot | 0.99 | 2/190 | `net.h2_control_flood`, `net.no_js_execution` |
| `h2-rapid-reset` | bot | 0.99 | 2/190 | `net.h2_rapid_reset`, `net.no_js_execution` |
| `h2-settings-split` | bot | 0.96 | 2/190 | `net.h2_settings_vs_order`, `net.no_js_execution` |
| `honeypot` | bot | 1.00 | 15/190 | `br.webdriver_present`, `br.cdp_runtime_enabled`, `br.honeypot_interaction` +4 |
| `http2-naive` | bot | 1.00 | 7/190 | `net.h2_header_order_vs_ua`, `net.h2_vs_tls_browser`, `net.tcp_os_vs_ua` +4 |
| `human-mouse` | bot | 1.00 | 13/190 | `br.webdriver_present`, `br.cdp_runtime_enabled`, `br.headless_ua` +3 |
| `iframe-spoof` | bot | 1.00 | 21/190 | `br.ua_platform_vs_ch_platform`, `br.cdp_runtime_enabled`, `net.ch_platform_header_vs_ua` +9 |
| `ios-ua-spoof` | bot | 1.00 | 22/190 | `net.tls_vs_ua_browser`, `net.h2_vs_ua_browser`, `br.ua_platform_vs_ch_platform` +11 |
| `ip-rotation` | bot | 1.00 | 5/190 | `net.ip_rotation_within_session`, `net.no_js_execution`, `net.sec_fetch_vs_ua` +2 |
| `keystroke-human` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +3 |
| `lang-list-spoof` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +4 |
| `lang-spoof` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +4 |
| `linear-bot` | bot | 1.00 | 17/190 | `br.webdriver_present`, `br.cdp_runtime_enabled`, `br.headless_ua` +3 |
| `max-stealth` | bot | 0.99 | 10/190 | `br.webdriver_spoofed`, `br.permissions_anomaly`, `br.no_chrome_object` |
| `measuretext-spoof` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +4 |
| `mobile-emulation` | bot | 1.00 | 14/190 | `br.webdriver_present`, `br.cdp_runtime_enabled`, `br.ch_he_headless` +3 |
| `mobile-no-touch` | bot | 1.00 | 24/190 | `net.tls_vs_ua_browser`, `net.h2_vs_ua_browser`, `br.automation_globals` +11 |
| `naive-tz-spoof` | bot | 1.00 | 16/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +6 |
| `native-spoof` | bot | 1.00 | 16/190 | `br.native_invariant_violated`, `br.cdp_runtime_enabled`, `br.headless_ua` +6 |
| `nodriver` | bot | 0.92 | 7/190 | `br.headless_ua` |
| `os-spoof` | bot | 1.00 | 16/190 | `br.cdp_runtime_enabled`, `net.ch_ua_version_vs_ua`, `net.tcp_os_vs_ua` +5 |
| `patchright-headful` | suspicious | 0.46 | 4/190 | — |
| `patchright` | bot | 1.00 | 10/190 | `br.headless_ua`, `br.ch_he_headless`, `br.permissions_anomaly` +1 |
| `playwright-extra-coherent` | bot | 1.00 | 12/190 | `br.cdp_runtime_enabled`, `br.ch_he_headless`, `br.worker_divergence` +2 |
| `playwright-extra` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `net.tcp_os_vs_ua`, `br.ch_he_headless` +3 |
| `primp` | bot | 0.97 | 2/190 | `net.tcp_os_vs_ua`, `net.no_js_execution` |
| `pydoll` | bot | 0.92 | 7/190 | `br.headless_ua` |
...
| `stale-engine` | bot | 1.00 | 15/190 | `br.cdp_runtime_enabled`, `net.ch_ua_version_vs_ua`, `br.ch_he_headless` +5 |
| `stealth-naive` | bot | 1.00 | 13/190 | `br.webdriver_present`, `br.cdp_runtime_enabled`, `br.headless_ua` +3 |
| `stealth-patched` | bot | 1.00 | 19/190 | `br.cdp_runtime_enabled`, `net.ch_ua_version_vs_ua`, `net.tcp_os_vs_ua` +7 |
| `tls-stale-template` | bot | 1.00 | 6/190 | `net.tcp_os_vs_ua`, `net.no_js_execution`, `net.sec_fetch_vs_ua` +3 |
| `trace-replay` | bot | 1.00 | 13/190 | `bh.trace_replay_within_session`, `br.cdp_runtime_enabled`, `br.headless_ua` +4 |
| `tz-spoof` | bot | 1.00 | 16/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +6 |
| `ua-rotation` | bot | 1.00 | 8/190 | `net.h2_unknown_vs_ua`, `net.h2_header_order_vs_ua`, `net.ua_rotation_within_session` +5 |
| `uach-coherent` | bot | 1.00 | 11/190 | `br.cdp_runtime_enabled`, `br.permissions_anomaly`, `br.no_chrome_object` +1 |
| `undetected` | bot | 0.92 | 7/190 | `br.headless_ua` |
| `vanilla` | bot | 1.00 | 5/190 | `net.tcp_os_vs_ua`, `net.no_js_execution`, `net.sec_fetch_vs_ua` +2 |
| `webgl-caps-worker-spoof` | bot | 1.00 | 12/190 | `br.automation_globals`, `net.tls_ext_order_static_within_session`, `br.webdriver_present` +3 |
| `webgl-renderer-spoof` | bot | 1.00 | 21/190 | `br.automation_globals`, `net.tls_ext_order_static_within_session`, `br.webdriver_present` +9 |
| `webkit-safari-coherent` | bot | 1.00 | 9/190 | `net.h2_unknown_vs_ua`, `br.webdriver_present`, `net.tcp_os_vs_ua` +3 |
| `webkit-ua-spoof` | bot | 1.00 | 18/190 | `net.tls_vs_ua_browser`, `net.h2_unknown_vs_ua`, `net.h2_header_order_vs_ua` +8 |
| `webrtc-leak` | suspicious | 0.49 | 5/190 | — |
| `webrtc-origin-datacenter` | bot | 1.00 | 7/190 | `net.datacenter_origin_proxied` |
| `worker-proxy-fix` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +4 |
| `worker-proxy` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +4 |
| `worker-spoof` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +4 |
| `worker-wrap` | bot | 1.00 | 14/190 | `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless` +4 |
| `zendriver-uach-behave` | suspicious | 0.49 | 6/190 | — |
