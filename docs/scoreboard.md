...
- generated: `2026-06-19T02:43:48.092410+00:00`
- ruleset: `live`
...
| canvas-spoof | live | 0.00 | 1.00 | 0.55 | 0.00 | 0.00 | 1.00 | bot |
| tz-spoof | live | 0.00 | 1.00 | 0.00 | 0.00 | 0.00 | 1.00 | bot |
...
| camoufox | live | 0.95 | 0.99 | 0.75 | 0.00 | 0.84 | 1.00 | bot |
...
- **tz-spoof** (bot): `br.cdp_runtime_enabled`, `br.headless_ua`, `br.ch_he_headless`, `br.webgl_software`, `br.permissions_anomaly`, `br.no_chrome_object`, `br.no_plugins`, `br.webdriver_getter_tampered`, `br.timezone_worker_vs_main`, `br.no_pdfviewer`, `br.mimetypes_empty`, `br.notification_denied`, `br.voices_empty`, `br.media_devices_empty`, `br.timezone_inconsistent`, `br.math_engine_vs_ua`
...
- **camoufox** (bot): `net.quic_grease_vs_ua`, `bh.power_law_violation`, `net.tcp_os_vs_ua`, `bh.synthetic_no_coalesced`, `br.webgl2_missing`, `br.voices_empty`, `br.media_devices_empty`, `br.webrtc_unavailable`, `net.tls_grease_vs_ua`
