...
@pytest.mark.parametrize(
    ...
    [
        ...
        # br.chrome_runtime_missing retired v0.74.28 (FP on real Chrome 149: chrome.runtime undefined on
        ...
        ([(Layer.network, "web_bot_auth_invalid", True, Source.edge)], "net.web_bot_auth_invalid"),
        ...
        ([(Layer.browser, "screen_depth_incoherent", True, Source.collector)], "br.screen_depth_incoherent"),
        ([(Layer.browser, "battery_api_vs_gecko_ua", True, Source.collector)], "br.battery_api_vs_gecko_ua"),
        ...
        (
            [(Layer.browser, "devicememory_worker_divergence", True, Source.collector)],
